...
class ImageController
{
     ...
     * @param array<string, mixed> $params
     */
    public function listAllImages(Request $request, array $params = []): JsonResponse
    {
        $category = $params['category'];

        return new JsonResponse($this->repository->getAllImages($category));
    }
     ...
     * @param array<string, mixed> $params
     */
    public function randomImageAny(Request $request, array $params = []): Response
    {
        $image = $this->repository->getRandomImageFileFromAny();
